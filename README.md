...
- We include a taxnomy tree of representative approaches in this field (adapted from our large-scale study paper) at the [bottom](#taxonomy-tree) and [here](https://sokcertifiedrobustness.github.io).
...
| [Lipschitz-Certifiable Training with a Tight Outer Bound](https://papers.nips.cc/paper/2020/file/c46482dd5d39742f0bfd417b492d0e8e-Paper.pdf) | Lee et al     | 6C2F            | 51.30% |                                        |
| [Globally-Robust Neural Networks](https://arxiv.org/abs/2102.08452) | Leino et al   | GloRo-T         | 51.0%  |                                        |
...
| Defense/Verification                                         | Author           | Model Structure    | RACC   |                             |
| ------------------------------------------------------------ | ---------------- | ------------------ | ------ | --------------------------- |
| [Consistency Regularization for Certified Robustness of Smoothed Classifiers](https://arxiv.org/pdf/2006.04062.pdf) | Jeong et al      | LeNet              | 82.2%  | slightly smaller radius 1.5 |
| [Globally-Robust Neural Networks](https://arxiv.org/abs/2102.08452) | Leino et al      | GloRo-T            | 51.9%  |                             |
| [Lipschitz-Certifiable Training with a Tight Outer Bound](https://papers.nips.cc/paper/2020/file/c46482dd5d39742f0bfd417b492d0e8e-Paper.pdf) | Lee et al        | 4C3F               | 47.95% |                             |
| [Scaling provable adversarial defenses](https://arxiv.org/pdf/1805.12514.pdf) | Wong et al       | Large CNN          | 44.53% |                             |
